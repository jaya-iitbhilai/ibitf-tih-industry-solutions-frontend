...
const SubmitProblemPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert(
      "Thank you for submitting your problem statement. Our team will review it and get back to you soon."
    )
    // Reset form
    setFormData({
      name: "",
  ...
  return (
    <div>
      <section className="bg-gray-50 py-12">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 mb-0">
            We welcome problem statements from various domains, including
            technology, healthcare, sustainability, and more.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-blue-50" id="submit">
